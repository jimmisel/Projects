...
var divWriter = function (string) {
    document.getElementById('extraDiv').innerHTML = string;
}

//load messages when the page loads for the first time
myTask.getTasks = function (success, error) {
    var request = new XMLHttpRequest();
    request.open("GET", 'https://jimstodolist.firebaseio.com/.json');
...
myTask.getTasks(divWriter, function (data) {
    console.log(data);
});
